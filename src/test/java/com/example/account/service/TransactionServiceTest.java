...
class TransactionServiceTest {
    ...
    @Test
    @DisplayName("계좌 소유주 다름 - 거래 조회 실패")
    ...
    @Test
    @DisplayName("1년보다 오래 된 거래는 취소 불가 - 잔액 사용 취소 실패")
    void cancelTransaction_TooOlderToCancel() {
        //given
        AccountUser user = AccountUser.builder()
                .name("Pobi").build();
        user.setId(12L);
        ...
        Transaction transaction = Transaction.builder()
                ...
                .transactionResultType(S)
                .transactionId("transactionId")
                // minusYears(1) 만 붙여도 정확히 1년으로 계산해주기 때문에 가능
